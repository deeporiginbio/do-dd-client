"""
Protein information retrieval and HTML report generation.

Provides functions for fetching comprehensive protein data from the RCSB PDB
GraphQL API and generating interactive HTML reports from that data.
"""
